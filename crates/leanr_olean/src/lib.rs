...
pub use module_data::{
    CatBehavior, DiscrKey, EntryScope, Import, MatcherAltInfo, MatcherEntry, ModuleData,
    ParserEntry, PartKind, ReducibilityEntry, ReducibilityStatus, ScopedParserEntry,
};
